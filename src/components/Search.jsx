    ...
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      ...
      <div className="left flex-1">
        <motion.img
          ...
          alt=""
          className="absolute top-[22rem] left-[-47rem] w-[100%] z-0"
        />
        <motion.img
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem] ">
        {/* Search */}
        <div className="searchbar flex justify-start w-[100%] z-10 ">
          <input
            type="text"
        ...
        {/* tild icon */}
        <div className="tild flex justify-start mt-7 items-center w-[100%] z-10">
          <img
        ...
        {/* paragraph */}
        <div className="detail flex flex-col mt-5 text-4xl z-10">
